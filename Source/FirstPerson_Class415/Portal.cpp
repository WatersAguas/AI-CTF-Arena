...
{
	AFirstPerson_Class415Character* playerChar = Cast<AFirstPerson_Class415Character>(OtherActor);
	...
	if (playerChar)
	{
		if (OtherPortal)
		{
			if (!playerChar->isTeleporting)
			{
				...
				// allows to passthrough playerChar without opening the portal infinitely.
...
void APortal::SetBool(AFirstPerson_Class415Character* playerChar)
{
	if (playerChar)
	{
